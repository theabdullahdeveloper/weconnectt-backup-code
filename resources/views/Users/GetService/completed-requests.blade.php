            ...
            @foreach($leads as $lead)
                    <div class="card border-0 col-md-5 col-sm-12 pt-3 pb-3 px-3 mb-2 ml-auto mr-auto">
                        ...
                        <div class="card-body text-center">
                            ...
                            <!-- <a href="#" class="btn btn-success btn-small msc">Mark complete</a> -->
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewRequestModalLabel_{{ $lead->id }}">{{ $lead->service_sub_category }} Request Details</h5>
